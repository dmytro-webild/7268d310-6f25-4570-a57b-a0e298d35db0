...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/front-view-young-female-holding-basket-with-potato-chips-blue-surface_140725-69573.jpg",
          alt: "Customer 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/food-blogger-healthy-fitness-chef-recording-video-social-media-shredding-carrot_140725-166742.jpg",
          alt: "Customer 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/smiling-caucasian-female-model-eating-fancy-cupcake-outdoor-summer-cafeteria_291650-647.jpg",
          alt: "Customer 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/vertical-shot-curly-haired-beautiful-woman-bites-pastries-with-appetite-winks-eye-keeps-mouth-widely-opened-addiction-sugar-sweet-food-wears-casual-t-shirt-unhealthy-eating-concept_273609-62637.jpg",
          alt: "Customer 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/front-view-young-female-holding-basket-with-potato-chips-blue-surface_140725-69573.jpg",
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          name: "Spicy Jalapeno",
          price: "$5.49",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-different-snacks-popcorn-rusks-cips-dark-surface_140725-90977.jpg",
        },
        {
          id: "p3",
          name: "Truffle & Parmesan",
          price: "$6.99",
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-delicious-homemade-chips-newspaper-gray-table_140725-87115.jpg",
        },
      ]}
      ...
      features={[
        {
          id: "f1",
          title: "Farm Fresh",
          description: "Sourced from locally managed sustainable farms.",
          tag: "Quality",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-potatoes-with-copy-space_23-2148622486.jpg",
        },
        {
          id: "f2",
          title: "Small Batch Crafted",
          description: "Made in small batches to ensure consistent perfection.",
          tag: "Craft",
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-dough-with-flour-sieve-human-hand_176474-3069.jpg",
        },
        {
          id: "f3",
          title: "Eco-Friendly",
          description: "Compostable packaging for a greener planet.",
          tag: "Eco",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-chocolate-chip-cookies-with-cereals-nuts-cocoa-tied-with-rope-wooden_141793-6345.jpg",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "We are available in local supermarkets.",
        },
        {
          id: "faq2",
          title: "Are they gluten free?",
          content: "Yes, all our chips are gluten-free certified.",
        },
        {
          id: "faq3",
